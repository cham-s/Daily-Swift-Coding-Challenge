import XCTest
@testable import Challenge62

final class Challenge62Tests: XCTestCase {
    func testOnTheHour() {
    ...
    func testAddAcrossMidnight() {
        var clock = Clock(hours: 23, minutes: 59)
        clock.add(minutes: 2)
    ...
    func testSubtractMoreThanTwoDays() {
        var clock = Clock(hours: 2, minutes: 20)
